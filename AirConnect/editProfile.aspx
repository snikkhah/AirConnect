<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editProfile.aspx.cs" Inherits="AirConnect.editProfile" %>
                    ...
                    <div class="panel-heading"><h4><asp:Label runat="server" ID="user"></asp:Label><span class="glyphicon glyphicon-user pull-right"></span></h4></div>
                        <div class="panel-body">
                            ...
                            <div class="input-group">
                              ...
                              <asp:TextBox runat="server" ID="firstName" type="text" class="form-control" placeholder="First Name"/>
                            </div>
                            <div class="input-group">
                              <span class="input-group-addon">Last Name</span>
                              <asp:TextBox runat="server" ID="lastName" type="text" class="form-control" placeholder="Last Name"/>
                            </div>
                            <div class="input-group">
                              <span class="input-group-addon">Password</span>
                              <asp:TextBox runat="server" ID="password" type="password" class="form-control" placeholder="Enter a new password"/>
                            </div>
                            <div class="input-group">
                              <span class="input-group-addon">Confirm Password</span>
                              <asp:TextBox runat="server" ID="confirmPassword" type="password" class="form-control" placeholder="Confirm your new password"/>
                            </div>
                            <div class="input-group">
                              <span class="input-group-addon">Points</span>
                              <asp:TextBox runat="server" ID="points" type="text" class="form-control" placeholder="Points"/>
                            </div>
